      ...
      <div class="row mx-auto" style="margin-top: 10rem;">
        ...
        <div class="col-lg-4 col-md-12 col-sm-1">
          <div class="card shadow border-0">
            <img src="../public/picture/kitchenroom/kitchen_room1.jpg" class="card-img-top" style="max-height: 20rem;">
            <div class="card-body">
              <h5 class="card-title text-center">Tibur House</h5>
              <p class="card-text " style="text-align: justify;">This 15-square-metre addition to the rear of a house in north London contains a bright, open-plan kitchen and dining area.

              Architecture studio Paul Archer Design topped a side extension with a skylight that runs the length of the kitchen while full-height glass doors let light into a dining area.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 mt-5 mt-lg-0">
          <div class="card shadow border-0">
            <img src="../public/picture/kitchenroom/kitchen_room2.jpg" class="card-img-top" style="max-height: 20rem;">
            <div class="card-body">
              <h5 class="card-title text-center">Overcast House</h5>
              <p class="card-text " style="text-align: justify;">Designed for a colour consultant, this kitchen extension by Office S&M in London combines several on-trend colours including Millennium Pink and Mint Green.

              The space also doubles up as an area for the consultant to work and meet with clients, so it was essential that the kitchen was evenly lit.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 mt-5 mt-lg-0">
          <div class="card shadow border-0">
            <img src="../public/picture/kitchenroom/kitchen_room3.jpg" class="card-img-top" style="max-height: 20rem;">
            <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 mt-5 mt-lg-3">
          <div class="card shadow border-0">
            <img src="../public/picture/kitchenroom/kitchen_room4.jpg" class="card-img-top" style="max-height: 20rem;">
            <div class="card-body">
              <h5 class="card-title text-center">Vikki's Place</h5>
              <p class="card-text " style="text-align: justify;">Curious Practice used birch plywood throughout the interiors of this multi-generational home in the Australian city of Newcastle.

              In the kitchen, which is bookended by sliding glass doors, birch plywood was also used to make simple open-face cabinets that were paired with countertops clad in stainless steel.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 mt-5 mt-lg-3">
          <div class="card shadow border-0">
            <img src="../public/picture/kitchenroom/kitchen_room.jpg" class="card-img-top" style="max-height: 20rem;">
            <div class="card-body">
              <h5 class="card-title text-center">House in Los Vilos</h5>
              <p class="card-text " style="text-align: justify;">Designed as a retreat on the Chilean coast by Pritzker Prize-winning architect Ryue Nishizawa, House in Los Vilos has a spectacular kitchen flanked on both sides by full-height glass walls.

              Set under the home's wavy concrete roof, the kitchen has expansive views of the Pacific Ocean.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 mt-5 mt-lg-3">
          <div class="card shadow border-0">
            <img src="../public/picture/kitchenroom/kitchen_room5.jpg" class="card-img-top" style="max-height: 20rem;">
            <div class="card-body">
              <h5 class="card-title text-center">Brasília apartment </h5>
              <p class="card-text " style="text-align: justify;">TBrazilian studio Bloco Arquitetos stripped back this 1960s apartment in Brasília and divided it up using translucent partitions.

              At the front of the apartment, the kitchen is backed by a lattice-like wall with square cutouts that provides natural light and air to the apartment.</p>
            </div>
          </div>
        </div>
